...
class PlaceOrder extends Component{
    ...
    state = {
        ...
        paymentTypes: [
            ...
            {id: 4, value: 'cod', label: 'Pay at Venue', isActive: true},
        ]
    }
                        ...
                        <div className="DeliveryAddress">
...

                            {
                                this.state.isAddressConfirm ? 
                                 <div className="Card">
                                     <p className="CardText">Ticket Recipient {this.state.isAddressConfirm ? <i className="fas fa-check"></i> : null}</p>
                                     <p>
                                ...
                                <div className="Card">
                                    ...
                                    }
                                    {
                                        ...
                                        <div className="DeliveryButtonContainer" >
                                            <button onClick={this.confirmDeliveryAddress} className="DeliveryAddressButton">Confirm Recipient</button>
                                        </div> : null
                                    }
...

                                {
                                    ...
                                    <div className="Card">
                                        <p className="CardText">Booking Summary <i className="fas fa-check"></i> </p>
                                    </div> : 
                                    this.state.isAddressConfirm ? 
                                    <div className="Card">
                                        <h4 className="CardText">Booking Summary </h4>
                                        {
                                            this.props.cart.cartItem.map(item => (
                                                <div key={item.product} style={{display: 'flex', margin: '5px 0', alignItems: 'center'}}>
                                                    ...
                                                    <div>
                                                        <h5>{item.name}</h5>
                                                        <h6>Number of tickets: {item.quantity}</h6>
                                                        <h6>Rs.{item.total}</h6>
                                                    </div>
                                                </div>
                                            ))
                                ...
                                
                                {
                                    ...
                                    </ul>
                                    {
                                        ...
                                        <p className="ErrorMessage">Sorry, Only Pay at Venue is available</p> : null
                                    }
                                    <button className="PaymentConfirm" onClick={this.submitOrder}>Confirm Booking</button>
