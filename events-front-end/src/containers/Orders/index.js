        ...
        return (
            <React.Fragment>
                ...
                <div className="Content">
                    <div className="Card">
                        <p className="CardText">My Bookings</p>
                                ...
                                return (
                                    <div key={order._id} className="Order">
                                            ...
                                            {order.order.map(item => (
                                                <div key={item._id} style={{display: 'flex', alignItems: 'center', margin: '5px 0', borderBottom: '1px solid #cecece'}}>
                                                    ...
                                                    <div>
                                                        ...
                                                        <p>Number of tickets: {item.quantity}</p>
                                        ...
                                        <div className="OrderFooter">
                                            <p>Purchased On <span>{this.formatDate(order.orderDate)}</span></p>
                                            <p>Booking Total <span>Rs.{this.getOrderTotal(order._id)}</span></p>
                                        </div>
                                    </div>
                                )
                            })
