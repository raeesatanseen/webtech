...
class ProductDetails extends Component{
    ...
    addToCart = (productId, price, name, image) => {
        ...
        .then(response => {
            ...
            alert("Tickets for this event are added to cart");
        })
        .catch(error => {
            console.log(error);
        });
    ...
    render(){
        ...
        if(this.state.product){
                    ...
                    <div className="ProductDetailsWrapper">
                        <div className="ProductDetailsImage">
                            ...
                            <div className="ActionButtonWrapper">
                                <button onClick={() => { this.addToCart(product._id, product.price, product.name, product.productPic[0].img) }}><i className="fas fa-shopping-cart"></i>&nbsp;BOOK TICKETS</button>
                            </div>
                        </div>
            ...
            productDescription = <div>Event details are loading...!</div>
        }
